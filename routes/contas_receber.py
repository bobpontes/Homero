...
@contas_receber_bp.route("/contas_receber")
@login_required
def contas_receber():
...
@contas_receber_bp.route("/contas_receber/nova", methods=["POST"])
@login_required
def nova_receita():
...
@contas_receber_bp.route("/contas_receber/atualizar/<int:id>", methods=["POST"])
@login_required
...
@contas_receber_bp.route("/contas_receber/grupos")
@login_required
...
@contas_receber_bp.route("/contas_receber/grupo/<int:grupo_id>")
@login_required
...
@contas_receber_bp.route("/contas_receber/grupo/<int:grupo_id>/atualizar_valor", methods=["POST"])
@login_required
def atualizar_grupo_conta_receber(grupo_id):
    ...
    conn.close()
    return redirect(url_for("contas_receber.detalhar_grupo_conta_receber", grupo_id=grupo_id))

# Atualizar uma parcela individual dentro de um grupo:
@contas_receber_bp.route("/contas_receber/grupo/<int:grupo_id>/parcela/<int:id>/atualizar", methods=["POST"])
@login_required
...
@contas_receber_bp.route("/contas_receber/receber/<int:id>", methods=["POST"])
@login_required
...
@contas_receber_bp.route("/contas_receber/estornar/<int:id>", methods=["POST"])
@login_required
...
@contas_receber_bp.route("/contas_receber/remover/<int:id>", methods=["POST"])
@login_required
...
@contas_receber_bp.route("/contas_receber/remover_grupo/<int:grupo_id>", methods=["POST"])
@login_required
